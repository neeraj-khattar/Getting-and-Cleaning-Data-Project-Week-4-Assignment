...
# Third Step3 - Uses descriptive activity names to name the activities in the data set
...
# Fourth Step4 - Appropriately labels the data set with descriptive activity names. 
